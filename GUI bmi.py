...
#icon
image_icon=PhotoImage(file="C:/Users/priya/Desktop/Images_bmi/icon.png")
root.iconphoto(False,image_icon)

#top
top=PhotoImage(file="C:/Users/priya/Desktop/Images_bmi/top.png")
top_image=Label(root,image=top,background="#f0f1f5")
top_image.place(x=-10,y=-10)

#bottom box
Label(root,width=72,height=18,bg="lightpink").pack(side=BOTTOM)


ll=Label(root,font="arial 10",bg="white")
ll.place(x=80,y=80)

ll=ll.config(text="Height (in cm)")

ll2=Label(root,font="arial 10",bg="white")
ll2.place(x=300,y=80)
ll2=ll2.config(text="Weight (in kg)")


#two boxes
box=PhotoImage(file="C:/Users/priya/Desktop/Images_bmi/box.png")
Label(root,image=box).place(x=20,y=100)
Label(root,image=box).place(x=240,y=100)

#scale
scale=PhotoImage(file="C:/Users/priya/Desktop/Images_bmi/scale.png")
...
def slider_changed(event):
    ...
    img=(Image.open("C:/Users/priya/Desktop/Images_bmi/man.png"))
...
#command to change bg colour of scle
style =ttk.Style()
...
#man
secondimage=Label(root,bg="lightpink")
secondimage.place(x=70,y=530)


Button(root,text="View Report",width=15,height=2,font="arial 10 bold",bg="#1f6e68",fg="white",command=BMI).place(x=280,y=340)

label1=Label(root,font="arial 60 bold",bg="lightpink",fg="#fff")
label1.place(x=125,y=305)



label2=Label(root,font="arial 20 bold",bg="lightpink",fg="#3b3a3a")
label2.place(x=280,y=430)


label3=Label(root,font="arial 10 ",bg="lightpink")
